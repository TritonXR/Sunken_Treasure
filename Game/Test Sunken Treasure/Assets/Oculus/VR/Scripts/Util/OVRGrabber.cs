...
public class OVRGrabber : MonoBehaviour
{
    ...
    void OnUpdatedAnchors()
    {
        ...
        m_prevFlex = m_controller.GetComponent<OVRHand>().GetFingerPinchStrength(OVRHand.HandFinger.Thumb); 
        ...
        if (closestGrabbable != null)
        {
            ...
            if(m_grabbedObj.snapPosition)
            {
                ...
                if(m_grabbedObj.snapOffset)
                {
                    ...
                    if (m_controller == true) snapOffset.x = -snapOffset.x;
    ...
    protected void GrabEnd()
    {
        if (m_grabbedObj != null)
        {
			...
			Vector3 linearVelocity = trackingSpace.orientation * m_controller.GetComponentInParent<Rigidbody>().velocity;
			Vector3 angularVelocity = trackingSpace.orientation * m_controller.GetComponentInParent<Rigidbody>().angularVelocity;
